...
void setupTOFSensors() 
{
  ...
  delay(20);
  if (!lox0.begin(ADDR0)) Serial.println("Sensor 0 FAILED");
  else Serial.println("Sensor 0 OK");
}
...
void getTOFData(TimerHandle_t xTimer)
{
  VL53L0X_RangingMeasurementData_t m1, m2, m3, m4, m0;
  ...
  lox0.rangingTest(&m0, false);
  u0 = (m0.RangeStatus == 4 ? -1 : m0.RangeMilliMeter / 10.0);
}
