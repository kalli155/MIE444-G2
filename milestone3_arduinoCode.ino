...
/* ===================== Servo Position ===================== */
Servo myservo;
float setServoPos = 0;          // defines the position variable for the servo
int currentServoPos = 0;    

/* ===================== FREERTOS TIMER ===================== */
TimerHandle_t xAdjustSpeeds;
TimerHandle_t xPrintStatus;
TimerHandle_t xSetServoPosition;
...
// Servo Control
void setServoPosition(TimerHandle_t);
...
void setServoPosition(TimerHandle_t) 
{
  if (currentServoPos != round(setServoPos))
  {
    if (round(setServoPos) > currentServoPos)
    {
      currentServoPos++;
    }
    else
